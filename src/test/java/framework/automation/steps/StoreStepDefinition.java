...
public class StoreStepDefinition {
    ...
    public void ingresaEnLaBarraDeBusquedaYPresionaBuscar(String value) {
    ...
    public void seleccionaLaPrimeraOpcionQueApareceEnLosResultados() {
    ...
    public void haceClicEnElBotonDelCarritoDeCompras() {
